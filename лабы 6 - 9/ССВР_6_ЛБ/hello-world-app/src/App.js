...
import store from './store/store'; // Импортируем объединенный store
import './index.css';
        ...
        <Router>
          <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            ...
            <Container component="main" sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
              {isLoggedIn && (
                <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', alignItems: 'flex-end' }}> {/* Изменено на flex-end */}
                  <Button 
                    variant="contained" 
                    color="secondary" 
                    onClick={logout} 
                  ...
                  <Button 
                    ...
                    sx={{ marginBottom: 2 }} // Уменьшение размера кнопки
                  >
                    Обновить профиль
                  </Button>
